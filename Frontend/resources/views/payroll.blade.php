                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h1 class="page-head-line">Lecture payment
                                                        <a href="" class="btn btn-primary btn-sm pull-right">Add New<i class="glyphicon glyphicon-arrow-right"></i></a><a href="" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i>Update</a>
                                                    </h1>
                                                    <nav>
